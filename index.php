...
<body>
    ...
    <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background:#66CCFF">
        <div class="container" >
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.php" style="color:#FFFFFF">EnigmaD</a>
	...
	<li class="dropdown">
        ...
        <ul class="dropdown-menu">
          ...
          <li><a href="index.php?info=login">PWD</a></li>
		  <li><a href="index.php?info=faculty_login">Elected Representative</a></li> 
    ...
    <header id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                ...
                <div class="fill" style="background-image:url('https://get.wallhere.com/photo/capitol-White-House-america-government-653330.jpg');">
                	<img src="C:/Users/HP/Pictures/wallpaper/425604-amazing-marvel-hd-wallpaper-1920x1080.png">
                </div>
    ...
    <div class="container">
        ...
        <div class="row">
			...
			<div class="col-sm-10" style="margin-top:60px;margin-bottom:80px">
				<h2>ABOUT EnigmaD</h2>
				The Idea is to determine the count and location of Pothhole in an perticular area and let the representatives know about it using this web based Application.
